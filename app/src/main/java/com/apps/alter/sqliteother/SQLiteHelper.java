package com.apps.alter.sqliteother;
...
/**
 * Created by jolabti on 5/5/17.
 */
public class SQLiteHelper extends SQLiteOpenHelper {
    private static final String nama_database = "db_pemain.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(query_buat_tabel_biodata_pemain);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(query_hapus_tabel_biodata_pemain);
        onCreate(db);
    }
